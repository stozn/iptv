...
class ChannelListModel {
  Map channels = {
    ...
    'CETV-2':
        'http://ottrrs.hl.chinamobile.com/PLTV/88888888/224/3221226425/index.m3u8',
  ...
  Channel get(String name) {
    return Channel(name, channels[name]);
  }

  void add(String name, String src) => channels[name] = src;
  void del(String ch) => channels.removeWhere((key, value) => key == ch);
}
